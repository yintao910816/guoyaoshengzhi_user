...
let IMAGE_URL = "http://106.14.15.151:8080"

let HTTP_ROOT_URL = "http://106.14.15.151:8080"
let HTTP_HOST_URL = HTTP_ROOT_URL.appending("/patient-api/")

// 获取余额
let USER_BALANCE = "http://106.14.15.151:8089/api/pay/getPatientBalance"
...
// 单张图片上传
let HC_CE_URL = "http://106.14.15.151:8086"
let UPLOAD_SINGLE_IMAGE = HC_CE_URL + "/common-file/api/fileUpload/singleImg"

//app请求地址
let HC_ROOT_URL = "http://106.14.15.151:8080"
...
// 充值获取订单号
let HC_ORDERID = HC_HOST_URL + "api/payment/createRechargeOrder"
// 获取充值界面h5的url
let HC_PAY_H5URL = HC_HOST_URL + "api/patient/index/hrefH5"
